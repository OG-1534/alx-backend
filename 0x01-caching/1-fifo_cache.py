...
"""Create a class FIFOCache that inherits form BaseCaching
...
If the no. of items in self.cache_data is higher that BaseCaching.MAX_ITEMS:
...
class FIFOCache(BaseCaching):
    ...
    def put(self, key, item):
        """assign to dictionary item value for key key
